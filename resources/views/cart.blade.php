      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="cart">
            ...
            <h1 class="cart-title">In Your Shopping Cart: <span class="c-primary"> {{Cart::content()->count()}}
                items</span></h1>
              ...
              <tbody>
                ...
                <tr class="cart_item">
                  ...
                  <td class="product-remove">
                    <a href="{{ route('cart.delete', ['id' => $pdt->rowId ]) }}" class="product-del remove"
                  ...
                  <td class="product-thumbnail">
                    ...
                    <div class="cart-product__item">
                      <a href="#">
                        <img src="{{asset('storage/'.$pdt->model->image) }}" alt="product"
                  ...
                  <td class="product-quantity">
                    ...
                    <div class="quantity">
                      ...
                      <input title="Qty" class="email input-text qty text" value="{{$pdt->qty}}" type="text"
                ...
                <tr>
                  <td colspan="5" class="actions">
                    ...
                    <div class="coupon">
                      <input name="coupon_code" class="email input-standard-grey" value="" placeholder="Coupon code"
                        type="text">
